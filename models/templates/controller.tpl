...
// @Accept  json
// @Produce  json
// @Param input body requests.{{ToPascalCase .ModelName}}Request true "The {{ToPascalCase .ModelName }} to create"
// @Success 201 {object}  mdl.GeneralResp
// @Router /{{ToPascalCase .ModelName }} [post]
func Create{{ToPascalCase .ModelName }}(c *gin.Context) {
    var input mdl.{{ToPascalCase .ModelName}}
    ...
    c.JSON(http.StatusCreated, mdl.GeneralResp{
		Message: "Created {{ToPascalCase .ModelName}} successfully",
	})
}
...
// @Param input body requests.{{ToPascalCase .ModelName}}Request true "The {{ToPascalCase .ModelName }} to update"
...
func Update{{ToPascalCase .ModelName }}(c *gin.Context) {
    ...
    var data mdl.{{ToPascalCase .ModelName}}
